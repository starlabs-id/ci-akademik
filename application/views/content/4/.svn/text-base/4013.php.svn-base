	...
	<tbody id="f<?php echo $menu;?>dt">
		...
		?>
					<tr>
						...
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4113" class="upd" title="Evaluasi" onclick="change_page(this, event, 'Evaluasi')"><a/>
						</td>
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4213" class="upd" title="UTS" onclick="change_page(this, event, 'Ujian Tengah Semester')"><a/>
						</td>
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4313" class="upd" title="UAS" onclick="change_page(this, event, 'Ujian Akhir Semester')"><a/>
						</td>
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4413" class="upd" title="Rapor" onclick="change_page(this, event, 'Laporan Hasil Belajar')"><a/>
						</td>
					</tr>
		<?php
					$i++;
...
<br><br>
<div class="right">
	<a href="#" rel="4003" class="easyui-linkbutton" iconCls="icon-back" title="Back" onclick="go_back(this, event, 'Kelas')">Back<a/>
