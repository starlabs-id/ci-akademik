<div id="dkelas">
	<fieldset class="ss">
		<legend class="ss">Kelas <?php echo $kelas['nama_kelas']." / ".$semester." - ".$pelajaran;?></legend>
			...
			<label class="ss">&nbsp;</label>
			<a href="#" rel="<?php if($semester == 'Ganjil') echo 4012; else echo 4023;?>" class="easyui-linkbutton" iconCls="icon-back" title="Back" onclick="go_back(this, event, 'Nilai Akademis Semester <?php echo $semester?>')">Back<a/>
	</fieldset>
</div>