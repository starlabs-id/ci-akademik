	...
	<tbody id="f<?php echo $menu;?>dt">
		...
		?>
					<tr>
						...
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4024" class="upd" title="Semester Ganjil" onclick="change_page(this, event, 'Absen Siswa')"><a/>
						</td>
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="4034" class="upd" title="Semester Genap" onclick="change_page(this, event, 'Absen Siswa')"><a/>
						</td>
					</tr>
		<?php
					$i++;
