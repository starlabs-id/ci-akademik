<div id="dkelas">
	<fieldset class="ss">
		<legend class="ss">Kelas <?php echo $kelas['nama_kelas']." / ".$semester." - ".$pelajaran;?></legend>
			...
			<a href="#" rel="#f4423" pre="#f<?php if($semester == 'Ganjil') echo 4013; else echo 4023;?>" class="easyui-linkbutton" iconCls="icon-save" title="Save" onclick="save_r(this, event, '#dkelas')">Save<a/>
			<label class="ss">&nbsp;</label>
