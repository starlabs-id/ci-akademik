	...
	<tbody id="f<?php echo $menu;?>dt">
		...
		?>
					<tr>
						...
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="3021" class="upd" title="Semester Ganjil" onclick="change_page(this, event, 'Jadwal Pelajaran')"><a/>
						</td>
						<td class="center">
							<a href="#f<?php echo $menu;?>" rel="3031" class="upd" title="Semester Genap" onclick="change_page(this, event, 'Jadwal Pelajaran')"><a/>
						</td>
					</tr>
		<?php
					$i++;
