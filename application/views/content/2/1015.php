<div id="dkelas">
	<fieldset class="ss">
		<legend class="ss">Kelas <?php echo $kelas;?></legend>
			<input class="postit nama_kelas hide" value="<?php echo $kelas;?>"/>
			<table class="excel">
				<thead>
					...
					<?php
						if (!empty($dat['senin'])){
							...
							foreach ($dat['senin'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[senin][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[senin][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[senin][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
					...
					<?php
						if (!empty($dat['selasa'])){
							...
							foreach ($dat['selasa'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[selasa][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[selasa][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[selasa][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
					...
					<?php
						if (!empty($dat['rabu'])){
							...
							foreach ($dat['rabu'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[rabu][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[rabu][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[rabu][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
					...
					<?php
						if (!empty($dat['kamis'])){
							...
							foreach ($dat['kamis'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[kamis][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[kamis][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[kamis][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
					...
					<?php
						if (!empty($dat['jumat'])){
							...
							foreach ($dat['jumat'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[jumat][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[jumat][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[jumat][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
					...
					<?php
						if (!empty($dat['sabtu'])){
							...
							foreach ($dat['sabtu'] as $r=>$k){
								...
								echo "<tr>
										<td><input type='text' style='width:100%' class='postit hari[sabtu][0][jam] center readonly' value=''/></td>
										<td>
											<select class='postit hari[sabtu][0][id_mapel] readonly' style='width:100%'>
												<option></option>";
												foreach ($pelajaran as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
								...
								echo		"</select>
										...
										<td>
											<select class='postit hari[sabtu][0][id_guru] readonly' style='width:100%'>
												<option></option>";
												foreach ($guru as $j=>$v){
													echo "<option value='$v[id]'";
													echo ">$v[nm]</option>";
			...
			<a href="#" rel="#f1015" pre="#f1005" class="easyui-linkbutton" iconCls="icon-save" title="Save" onclick="save_r(this, event, '#dkelas')">Save<a/>
			<label class="ss">&nbsp;</label>
			<a href="#" rel="1005" class="easyui-linkbutton" iconCls="icon-back" title="Back" onclick="go_back(this, event, 'Kelas')">Back<a/>
	</fieldset>
</div>
