			...
			<?php foreach($dat as $r => $td) {?>
				<!--?php foreach($dat as $r => $td)?-->
					<tr>
						...
						<td class="postit NILAI center" val="<?php echo $td['NILAI'];?>"><?php echo $td['NILAI'];?></td>					
						<td class="center">
...
<div id="<?php echo 'f'.$menu?>" class="hide">
	<form class="ss">
		...
		<legend class="just_info ss">Nilai</legend>
			<label class="ss">NIM </label><input type="text" class="postit NIM_MHS wide ro pk" value=""/><br/>
